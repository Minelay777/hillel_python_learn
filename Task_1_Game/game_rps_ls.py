...
while True:
    ...
    player_choice: str = input('Your choice (rock paper scissors lizard spok)? ')  # просим игрока ввести свой выбор
    ...
    player_continue_choice = input(
        'Do you want to continue: y or n: ')  # спрашиваем, хочет ли игрок продолжить или закончить
